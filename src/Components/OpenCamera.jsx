...
function OpenCamera({ isCameraOpen, setIsCameraOpen, setCapturedImage }) {
 ...
 const getVideoDevices = async () => {
   try {
     ...
     setCameraDevices(highResDevices);
     console.log('High-resolution video devices:', highResDevices);


     if (highResDevices.length > 0) {
       setCurrentCameraId(highResDevices[0].deviceId); // Select the first high-res camera by default
     }
